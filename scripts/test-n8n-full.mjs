...
await scenario('Imobiliário PF — fluxo completo', [
  ...
  ['anderson@email.com',  'awaiting_city'],
...
await scenario('Crédito Rural PF', [
  ...
  ['2',                   'awaiting_email'],
  ['marcos@fazenda.com',  'awaiting_city'],
